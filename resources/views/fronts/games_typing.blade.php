...
@section('content')
    ...
    <main class="main" id="main">
        ...
        <p>レベルは {{ $level }} が選択されています。</p> --}}
            ...
            {{-- <div id="game-screen"> --}}
            <div class="gameBody" id="game-body">
                ...
                <div id="game-view1">
                    ...
                    {{-- 消すとゲームが動かなくなる！ --}}
                    {{-- 遊び方 --}}
                    <button class="game-position4" id="howto-playing" type="button"></button>
                    {{-- 設定 --}}
                    ...
                    {{-- <div class="Popup1">
                            ...
                            <label class="overlay" for="open"></label>
                    ...
                    {{-- <div class="Popup2">
                            ...
                            <label class="overlay" for="open2"></label>
                            <div class="popupContent">
                                <p>遊び方</p>
                ...
                <div id="game-view5" style="display: none;">
                    ...
                    <p>モードとコースを選んでください</p>
                    <p>練習モード</p>
                    <button class="game-position6" id="open-practise1" type="button">初級コース プレイ時間3分 1単語:7文字以下</button><br>
                    <button class="game-position7" id="open-practise2" type="button">中級コース プレイ時間3分 1単語:8文字以下</button><br>
                    <p>ランキングモード</p>
                    <button class="game-position9" id="open-ranking1" type="button">初級コース プレイ時間2分 1単語:7文字以下</button><br>
                    <button class="game-position10" id="open-ranking2" type="button">中級コース プレイ時間1分 1単語:8文字以下</button><br>
                    <button class="game-position8" id="close-selectmode" type="button">言語を選び直す ▶トップへ戻る</button>
                </div>
                <!-- ゲーム画面２ -->
                <div id="game-view2">
                ...
                <div class="set-ranking" id="game-view7" style="display: none;">
                    ...
                    <div>
                        <button class="regist-ranking" id="return-start" type="button">スタートに戻る</button>
                    </div>
                </div>
            </div>
            {{-- </div> --}}
                ...
                window.addEventListener('DOMContentLoaded', () => {
                    (function(window, document) {
                        ...
                        function finish() {
                                    ...
                                    if (record[i]) {
                                        ...
                                        if (!!recordHTML) {
                                            ...
                                            if (missFlag) {
                                                ...
                                                html += '<span class="miss">' + wordR[idx1][pattern[idx1]][idx2] +
                                                    '</span>';
                                                missFlag = false;
                                            } else {
                            ...
                            html += '<li><div class="title">レベル</div><div class="data">' + getLevel(score) +
                                '</div></li>';
                            html += '<li><div class="title">入力時間</div><div class="data">' + convTime(time) +
                                '</div></li>';
                            ...
                            html += '<li><div class="title">WPM</div><div class="data">' + convStr(speed.toFixed(2)) +
                                '</div></li>';
                            html += '<li><div class="title">正確率</div><div class="data">' + convStr((accuracy * 100)
                                .toFixed(2)) + '%</div></li>';
                            html += '<li><div class="title">苦手キー</div><div class="data">' + getWeaks(weakKeys) +
                                '</div></li>';
                            html += '</ul>';
                                    ...
                                    if (key == 'Escape') { // Escを押した場合
                                        ...
                                        if (key == wordR[idx1][pattern[idx1]][idx2]) {
                                            ...
                                            if (key == wordR[idx1][pattern[idx1]][idx2]) {
                                                ...
                                                if (wordR[idx1][pattern[idx1]] == 'nn' && wordR[idx1].length ==
                                                    3) { // 「ん」の特別措置

        ...
        <div class="mainContent">
            ...
            <div class="selectWrap">
                <select onchange="window.location.href = this.value;">
                    <option value="{{ route('ranking', ['level_id' => 1]) }}"
                        {{ request()->query('level_id') == 1 ? 'selected' : '' }}>初級</option>
                    <option value="{{ route('ranking', ['level_id' => 2]) }}"
                        {{ request()->query('level_id') == 2 ? 'selected' : '' }}>中級</option>
                </select>
            </div>

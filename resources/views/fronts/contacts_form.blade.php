                ...
                <table class="requiredTable">
                    <tr class="contactName">
                        ...
                        <td class="contactBody">
                            <input class="formText" name="contact_name" placeholder="山田太郎" required type="text" value="{{ old('contact_name') }}">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="contactBody">
                            <input class="formText" name="email" placeholder="typing@mail.com" required type="email" value="{{ old('email') }}">
                        </td>
                    </tr>
                    ...
                    <div class="contactBottom">
                        <p>詳細についてはご利用規約を確認ください</p>
                            ...
                            <div align="center" class="buttom">
                                ...
                                <input class="contactSubmit" onclick="return confirm_dialog('記事を送信します。よろしいでしょうか？')" type="submit" value="確認画面へ進む">
                            </div>
            </div>
</div>
</form>
